...
export const AINotesMakerScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
    ...
    // ========== EXPORT ==========
    const handleExportSummary = async (summary: AISummary) => {
        try {
            const textContent = await exportSummaryAsText(summary.id);
            ...
            if (isWeb) {
                ...
                const fileUri = `${FileSystem.documentDirectory}${summary.title.replace(/[^a-z0-9]/gi, '_')}.txt`;
            ...
            {summaries.map(summary => (
                <View key={summary.id} style={styles.summaryCard}>
                    ...
                    <View style={styles.summaryActions}>
                        ...
                        <TouchableOpacity style={styles.summaryAction} onPress={() => handleExportSummary(summary)}>
            ...
            <Modal visible={true} animationType="slide">
                <SafeAreaView style={styles.detailContainer}>
                    <View style={styles.detailHeader}>
                        ...
                        <TouchableOpacity onPress={() => handleExportSummary(showSummaryDetail)}>
