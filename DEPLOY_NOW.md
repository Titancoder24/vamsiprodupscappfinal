...
- Project name: → `upsc-admin-panel` (or press Enter)
...
- Which scope? → Select your account
- Link to existing project? → **N** (No, first time)
- Project name: → `upsc-mobile-app` (or press Enter)
- Directory: → `./` (press Enter)
- Override settings? → **N** (No)
...
2. Click on **upsc-admin-panel** project
...
5. Click on **upsc-mobile-app** project
...
# Paste: https://pjubvuvqzwhvqxeeubcv.supabase.co
...
# Paste: postgresql://postgres:Darshu%401153@db.pjubvuvqzwhvqxeeubcv.supabase.co:5432/postgres
...
You'll get deployment URLs like:
